...
#     match = re.search(r"\[(debug|info|notice|warning|error|critical|alert|emergency)\]", line, re.IGNORECASE)
...
#     text = Text(f"[{level.upper()}] ", style=style)
